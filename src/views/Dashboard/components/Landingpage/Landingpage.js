...
const Landingpage = (props) => {
  ...
  useEffect(() => {
    ...
    $(".Slider").on("touchmove", function (e) {
      ...
      let touchPosition = e.touches[0].clientX + 25;
      ...
      if (touchPosition > sliderRightEdge) {
        if (!(touchPosition > sliderContainerRightEdge)) {
          let widthShouldBe = touchPosition - sliderLeftEdge;
