...
const  mouseout14 = event => {
  ...
  return (
    <Grid container xs={12} md={12} lg={12} align="center" class='MainContainer' style={{background:'white'}}>
      <Grid container align='center' xs={12}>
        <Grid container xs={12}>
          <Grid item md={8} align='center' lg={8} className={classes.transparencyBox}> 
        </Grid>
        <Grid container xs={12}>
          <Grid item xs={12} align='center' lg={12} style={{zIndex:'4'}}>
  ...
  <Grid container id="ButtonMobile"  xs={12} style={{marginTop:'10vh'}}>
    <Grid item id="AppleDesktop" direction="column" xs={6} justify='right' align='right' style={{paddingRight:'4vh'}} >  
      <Grid item xs={12}>
        <ButtonApple />
      </Grid>
    </Grid>
    <Grid item id="AppleMobile" direction="column" xs={6} justify='right' align='right' style={{paddingRight:'2vh'}} >  
      <Grid item xs={12}>
        ...
        >
          ...
          <Typography style={{color:'white',fontSize:'10px',fontWeight:'bold',lineHeight:'20px'}}>
            Download on the
            <br/>
            <span style={{fontWeight:'bold',fontSize:'18px',textTransform:'none'}}>
              App Store
            </span>
          </Typography> 
          <br/> 
    ...
    <Grid item id="GoogleDesktop" direction="column" xs={6} justify='left' align='left' style={{paddingLeft:'.5vh'}}>  
      <Grid item xs={12}>
        <ButtonGoogle />
      </Grid>
    </Grid>
    <Grid item id="GoogleMobile" direction="column" xs={6} justify='left' align='left' style={{paddingLeft:'2vh'}}>  
      <Grid item xs={12}>
      <Button variant="contained" color="primary" 
        style={{
          background:'white',
    ...
    <Grid item id="CountDesktop" direction="column" sm={6} md={6} lg={6} justify='left' align='left' style={{paddingLeft:'4vh'}} >
      <Grid  item xs={12} style={{paddingTop:'15vh'}}>
  ...
  <Grid container xs={12} align='center'>
    <Grid id="CarouselMobile" container direction="column" sm={12} md={12} lg={12} justify='center' align='center'> 
      <Grid  item align='center' xs={12} align='center' style={{paddingTop:'5vh'}}>
        <img  src={require('../../../../assets/carouselphone.png')}  style={{zIndex:'20',width:'310px',height:'350px'}}></img>    
        <Grid item id="ContentUnderMobile" direction="column" xs={12} align="center" style={{paddingTop:'4vh'}}>
          <Typography className={classes.SendAndReceiveMobile}>
            Send & Receive
          </Typography>
        </Grid>
      </Grid>
      <Grid id="CountMobile" align='center' item xs={12} style={{paddingTop:'5vh'}}>
        <img src={require('../../../../assets/countmobile.png')}  style={{zIndex:'20',width:'310px',height:'350px'}}></img>    
      </Grid>
      <Grid id="CountMobile" item xs={12} sm={12} lg={12} direction="column" align='center'>
        <Typography className={classes.SendAndReceiveMobile} style={{paddingTop:'5vh'}}>
          Earn & Save  
        </Typography>
      </Grid>
      <Grid id="CountMobile" item xs={12} direction="column" align='center' style={{paddingTop:'3vh'}}>
        <Typography style={{color:'rgb(110, 120, 152)',fontSize:'12px',fontWeight:'500'}}>
          Every dollar in your Dharma account is earning 0.7% APR — 
          and you can withdraw it<br/> anytime; 24/7/365.
        </Typography>
      </Grid>
    </Grid>
      {/* <Grid container xs={12}>
  ...
  <Grid container align='right' xs={12} id="desktop" style={{paddingTop:'5vh'}}>
    ...
    <Grid item xs={12} align='center' style={{paddingRight:'20vh',paddingTop:'5vh'}}>
      <Typography style={{lineHeight:'32px',color:'rgb(110, 120, 152)',fontSize:'20px'}}>
  ...
  <Grid container xs={12} align='center'>
    <Grid item xs={12} id="CarouselDesktop" align='center' style={{marginTop:'80px'}}>
      <Button 
  ...
  <Grid container xs={12} align='center'>
    <Grid item xs={12} id="CarouselMobile" align='center'>
      <Button 
        style={{height:'40px',borderRadius:'20px',width:'175px'}}
        variant="contained" 
        className={classes.VideoButtonMobile}
      >
        <svg width="15" align='center' height="15" style={{marginRight:'1vh'}} viewBox="0 0 12 14" fill="none" xmlns="http://www.w3.org/2000/svg" class="sc-bZQynM iJaZLJ"><path d="M1 2.76619V11.2338C1 12.0111 1.84797 12.4912 2.5145 12.0913L9.57084 7.85749C10.2182 7.46909 10.2182 6.53091 9.57084 6.14251L2.5145 1.9087C1.84797 1.50878 1 1.9889 1 2.76619Z" stroke="url(#paint0_linear)" stroke-width="2"></path><defs><linearGradient id="paint0_linear" x1="11" y1="1" x2="7.04888" y2="14.5814" gradientUnits="userSpaceOnUse"><stop offset="0.0288666" stop-color="#FEA41C"></stop><stop offset="0.223691" stop-color="#FF5F61"></stop><stop offset="0.408517" stop-color="#FF2FA9"></stop><stop offset="0.628457" stop-color="#FE1CD5"></stop><stop offset="0.733043" stop-color="#CD1CEE"></stop><stop offset="0.864847" stop-color="#8C23F9"></stop><stop offset="0.96226" stop-color="#4635FF"></stop></linearGradient></defs></svg>
         Watch our video
      </Button>
  ...
  <Grid container xs={12} alignItems='center' justify='space-evenly'>
    <Grid item lg={3} sm={12} align='center' style={{paddingTop:'5vh'}}>
  ...
  <Grid container xs={12}   direction="row" justify="space-evenly" alignItems="center">
            ...
            <Grid item xs={12} align='center' style={{paddingTop:'10vh'}}>
             <svg width="34" height="34" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg" style={{marginBottom:'5vh'}} class="sc-bZQynM gOAebT"><path fill-rule="evenodd" clip-rule="evenodd" d="M16 2.12292C14.3758 2.52255 12.7922 3.8928 11.5076 6.17655C11.1912 6.73903 10.8984 7.34876 10.633 8H16V2.12292ZM9.76446 5.19603C9.28388 6.05041 8.85673 6.99025 8.49049 8H4.9989C6.5703 5.90795 8.67597 4.24015 11.1134 3.19916C10.6211 3.80376 10.17 4.47504 9.76446 5.19603ZM7.86948 10H3.73009C2.77228 11.812 2.17473 13.8438 2.0328 16H7.01672C7.08788 13.8778 7.38426 11.8525 7.86948 10ZM16 10H9.94346C9.4235 11.807 9.09564 13.8365 9.01791 16H16V10ZM18 16V10H24.0565C24.5765 11.807 24.9044 13.8365 24.9821 16H18ZM26.9833 16C26.9121 13.8778 26.6157 11.8525 26.1305 10H30.2699C31.2277 11.812 31.8253 13.8438 31.9672 16H26.9833ZM25.5095 8H29.0011C27.4297 5.90795 25.324 4.24015 22.8866 3.19916C23.3789 3.80376 23.83 4.47505 24.2355 5.19603C24.7161 6.05041 25.1433 6.99025 25.5095 8ZM18 8H23.367C23.1016 7.34876 22.8088 6.73903 22.4924 6.17655C21.2078 3.8928 19.6242 2.52255 18 2.12292V8ZM17 0C7.61116 0 0 7.61116 0 17C0 26.3888 7.61116 34 17 34C26.3888 34 34 26.3888 34 17C34 7.61116 26.3888 0 17 0ZM16 18H9.01791C9.09564 20.1635 9.4235 22.193 9.94346 24H16V18ZM16 26H10.633C10.8984 26.6512 11.1912 27.261 11.5076 27.8234C12.7922 30.1072 14.3758 31.4774 16 31.8771V26ZM7.86948 24C7.38426 22.1475 7.08788 20.1222 7.01672 18H2.0328C2.17473 20.1562 2.77228 22.188 3.73009 24H7.86948ZM4.9989 26H8.49049C8.85673 27.0098 9.28388 27.9496 9.76446 28.804C10.17 29.525 10.6211 30.1962 11.1134 30.8008C8.67598 29.7599 6.5703 28.092 4.9989 26ZM18 26H23.367C23.1016 26.6512 22.8088 27.261 22.4924 27.8234C21.2078 30.1072 19.6242 31.4775 18 31.8771V26ZM24.0565 24H18V18H24.9821C24.9044 20.1635 24.5765 22.193 24.0565 24ZM25.5095 26C25.1433 27.0098 24.7161 27.9496 24.2355 28.804C23.83 29.525 23.3789 30.1962 22.8866 30.8008C25.324 29.7599 27.4297 28.092 29.0011 26H25.5095ZM30.2699 24H26.1305C26.6157 22.1475 26.9121 20.1222 26.9833 18H31.9672C31.8253 20.1562 31.2277 22.188 30.2699 24Z" fill="url(#paint0_linear)"></path><defs><linearGradient id="paint0_linear" x1="34" y1="4.84006e-07" x2="24.4431" y2="39.4205" gradientUnits="userSpaceOnUse"><stop offset="0.0288666" stop-color="#FEA41C"></stop><stop offset="0.223691" stop-color="#FF5F61"></stop><stop offset="0.408517" stop-color="#FF2FA9"></stop><stop offset="0.628457" stop-color="#FE1CD5"></stop><stop offset="0.733043" stop-color="#CD1CEE"></stop><stop offset="0.864847" stop-color="#8C23F9"></stop><stop offset="0.96226" stop-color="#4635FF"></stop></linearGradient></defs></svg>
              ...
              <Grid item xs={12}>
              <Typography style={{fontSize:'16px',fontWeight:'400',marginTop:'26px',color:'rgb(110, 120, 152)'}}>No U.S. bank account?  No problem — deposit and withdraw using cryptocurrencies from anywhere in the world.</Typography>
              </Grid>
            </Grid>
            <Grid item lg={3} sm={12} align='center' style={{paddingTop:'10vh'}}>
          ...
          <Grid container xs={12} id="CarouselDesktop" style={{marginTop:'20vh'}} align='center'>
            <Grid item xs={12}>
              <Typography style={{color:'rgb(31, 42, 75)',fontSize:'36px',fontWeight:'600'}}>
                We're backed by the best
              </Typography>
            </Grid>
          </Grid>
          <Grid container xs={12} id="CarouselMobile" style={{marginTop:'10vh'}} align='center'>
            <Grid item xs={12}>
              <Typography style={{color:'rgb(31, 42, 75)',fontSize:'36px',fontWeight:'600',lineHeight:1.13}}>
                We're backed by the best
              </Typography>
            </Grid>
          </Grid>
          <Grid container xs={12} style={{marginTop:'10vh'}} id="CarouselDesktop">
            <Grid container xs={12} 
              style={{
                borderRadius:'25px',
          ...
          <Grid container xs={12} style={{marginTop:'10vh'}} align='center' id="CarouselMobile">
            <Grid container xs={12}
              align='center' 
              style={{
                borderRadius:'25px',
            ...
            >
              ...
              <Grid item xs={12} align='center' style={{}}>
                <Typography 
                  style={{color:'white',fontSize:'15px',lineHeight:'1.6',fontWeight:'500'}}
                >
                  Join thousands of people earning
                  <br/> 
              ...
              <Grid item xs={12} align='center'style={{marginTop:'-2vh'}}>
                <Button variant="contained" color="primary" 
                style={{
                  background:'rgb(31, 42, 75)',
                  color:'white',
                ...
                >
                  ...
                  <Typography 
                    style={{fontSize:'15px',color:'white',paddingLeft:'3vh',textAlign:'left'}}> 
                      <b>Get it on
                      <br/>
                      Google Play</b>
                  </Typography>      
          ...
          <Grid container xs={12} align='center' id="CarouselDesktop" style={{marginTop:'8vh'}}>
            <Grid item xs={2}/>
          ...
          <Grid container xs={12} id="CarouselMobile" align='center' style={{marginTop:'8vh'}}>
          ...
          <Grid container xs={12} id="CarouselDesktop" style={{marginTop:'10vh'}}>
            
            <Grid item xs={3}/>
            <Grid item xs={6} align='center'>
              <Typography style={{color:'rgb(110, 120, 152)',fontSize:'14px',fontWeight:'500',lineHeight:'1.6'}}>
                Digital currency is not legal tender, is not backed by
                the government, and digital currency accounts and <br/> 
                value balances on Dharma are not subject to Federal Deposit
                Insurance Corporation or Securities <br/>
                Investor Protection Corporation protections. Dharma is not
                a bank and does not offer fiduciary services. <br/>
                The interest rates reflected on this page are as of
                the current date and time, and may change at any time,<br/>
          ...
          <Grid container xs={12} style={{marginTop:'10vh'}}>
            ...
            <Grid item xs={3}/>
            <Grid item xs={6} id="CarouselMobile" align='center'>
              <Typography style={{color:'rgb(110, 120, 152)',fontSize:'14px',fontWeight:'500',lineHeight:'1.6'}}>
                Digital currency is not legal tender, is not backed by
                the government, and digital currency accounts and 
                value balances on Dharma are not subject to Federal Deposit
                Insurance Corporation or Securities 
                Investor Protection Corporation protections. Dharma is not
                a bank and does not offer fiduciary services.
                The interest rates reflected on this page are as of
                the current date and time, and may change at any time,
                before or after the account is opened on Dharma.
              </Typography>
            </Grid>
            <Grid item xs={3}/>
